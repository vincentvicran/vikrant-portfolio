export const projects = [
    ...
    },
    {
        ...
        description: 'ASP.NET core web application which provides the fluent online examination experience.',
        image: '/images/onlineexam.png',
        tags: ['ASP.NET core', 'MySQL', 'Bootstrap'],
        source: 'https://github.com/vincentvicran/OnlineExaminationSystem',
        visit: '',
        id: 2,
    },
];
...
export const TimeLineData = [
    { year: 2017, text: 'Started my journey; initiating with Python' },
    { year: 2018, text: 'Commenced the BScCSIT program' },
    { year: 2019, text: 'Explored the backend tools; specifically NodeJS' },
